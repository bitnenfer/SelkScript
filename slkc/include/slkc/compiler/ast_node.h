...
typedef enum skEAstNodeType
{
	...
	NODE_DECL_CONST,
	NODE_DECL_VAR,
	NODE_DECL_VAR_SIZED_ARRAY,
	NODE_DECL_VAR_NOSIZED_ARRAY,
	NODE_DECL_REFERENCE,
	NODE_DECL_VAR_LIST,
...
SK_FORCEINLINE ascii_char* sk_ast_node_name(skAstNode* node)
{
	...
	switch (type)
	{
		...
		case NODE_DECL_VAR_NOSIZED_ARRAY:
			return "NODE_DECL_VAR_NOSIZED_ARRAY";
		case NODE_DECL_VAR_SIZED_ARRAY:
			return "NODE_DECL_VAR_SIZED_ARRAY";
		case NODE_DECL_TYPE_VARNAME_PAIR:
			return "NODE_DECL_TYPE_VARNAME_PAIR";
